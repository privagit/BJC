  ...
  !(function (z) {
    ...
    (Y.VERSION = "1.13.14"),
      ...
      (Y.prototype = {
        ...
        isVirtual: function () {
          return (
            (!1 !== this.options.virtualScroll && this.selectpicker.main.elements.length >= this.options.virtualScroll) ||
              ...
              (t || a) &&
                ...
                (D.selectpicker.view.visibleElements =
                  !1 === u
                    ...
                    : D.selectpicker.current.elements.slice(D.selectpicker.view.position0, D.selectpicker.view.position1)),
                D.setOptionStatus(),
                (A || (!1 === u && t)) &&
                  (p = !(function (e, i) {
                    return (
              ...
              if (
                  ...
                  ? ((v = 0 === D.selectpicker.view.position0 ? 0 : D.selectpicker.current.data[D.selectpicker.view.position0 - 1].position),
                    (g =
                      D.selectpicker.view.position1 > d - 1
                        ? 0
                        : D.selectpicker.current.data[d - 1].position - D.selectpicker.current.data[D.selectpicker.view.position1 - 1].position),
                ...
                if (t && C < D.sizeInfo.menuInnerInnerWidth && D.sizeInfo.totalMenuWidth > D.sizeInfo.selectWidth)
                  ...
                  O > D.sizeInfo.menuInnerInnerWidth &&
                    ((D.sizeInfo.menuInnerInnerWidth = O), (b.firstChild.style.minWidth = D.sizeInfo.menuInnerInnerWidth + "px")),
            ...
            if (o.length) {
              ...
              for (var c = 0, d = o.length; c < d; c++) {
                ...
                0 === c && (l = (r = u.length - 1) + d),
                  v(h, { headerIndex: r, lastIndex: l, optID: a.optID, optgroupClass: a.optgroupClass, disabled: i.disabled });
              }
              n && m({ optID: f });
            }
          }
        ...
        buildList: function () {
          ...
          function t(e) {
            ...
            switch (e.type) {
              case "divider":
                ...
                break;
              case "option":
                (t = K.li(K.a(K.text.call(s, e), e.optionClass, e.inlineStyle), "", e.optID)).firstChild &&
                  (t.firstChild.id = s.selectId + "-" + e.index);
                break;
              case "optgroup-label":
          ...
          (!s.options.showTick && !s.multiple) ||
            ...
            ((_.checkMark.className = this.options.iconBase + " " + s.options.tickIcon + " check-mark"), _.a.appendChild(_.checkMark));
        ...
        render: function () {
          var e,
            ...
            d = !1;
          if ((r.classList.toggle("bs-placeholder", t.multiple ? !o : !T(i, n)), this.tabIndex(), "static" === this.options.selectedTextFormat))
            ...
            (this.multiple &&
              ...
              1 < o &&
              ((1 < (e = this.options.selectedTextFormat.split(">")).length && o > e[1]) || (1 === e.length && 2 <= o)))
          ) {
            if (!s) {
          ...
          if (
            (null == this.options.title && (this.options.title = this.$element.attr("title")),
            c.childNodes.length ||
              (c = K.text.call(this, { text: void 0 !== this.options.title ? this.options.title : this.options.noneSelectedText }, !0)),
        ...
        selectPosition: function () {
          ...
          this.$button.on("click.bs.dropdown.data-api", function () {
            r.isDisabled() ||
              (e(r.$newElement), r.$bsContainer.appendTo(r.options.container).toggleClass(V.SHOW, !r.$button.hasClass(V.SHOW)).append(r.$menu));
          }),
            z(window)
        ...
        checkDisabled: function () {
          this.isDisabled()
            ...
            : (this.$button[0].classList.contains(V.DISABLED) &&
                (this.$newElement[0].classList.remove(V.DISABLED), this.$button.removeClass(V.DISABLED).attr("aria-disabled", !1)),
          ...
          if (!(112 <= e.which && e.which <= 123))
            if (
              ...
              if ((e.which === N && i && (e.preventDefault(), a.$button.trigger("click.bs.dropdown.data-api").trigger("focus")), p)) {
                if (!c.length) return;
                -1 !== (t = (s = a.selectpicker.main.elements[a.activeIndex]) ? Array.prototype.indexOf.call(s.parentElement.children, s) : -1) &&
                  a.defocusItem(s),
                  e.which === B
                    ? (-1 !== t && t--,
                      t + f < 0 && (t += c.length),
                      a.selectpicker.view.canHighlight[t + f] ||
                        (-1 === (t = a.selectpicker.view.canHighlight.slice(0, t + f).lastIndexOf(!0) - f) && (t = c.length - 1)))
                    : (e.which !== M && !h) ||
