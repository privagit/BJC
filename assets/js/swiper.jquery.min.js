      ...
      if (
        ...
        (y.container[0].swiper = y),
          ...
          y.params.pagination &&
            ...
            "bullets" === y.params.paginationType && y.params.paginationClickable
          ...
          (y.preloadImages = function () {
            function e() {
              "undefined" != typeof y &&
                ...
                y.imagesLoaded === y.imagesToLoad.length && (y.params.updateOnImagesReady && y.update(), y.emit("onImagesReady", y)));
            }
            y.imagesToLoad = y.container.find("img");
            for (var a = 0; a < y.imagesToLoad.length; a++)
              y.loadImage(
                y.imagesToLoad[a],
                y.imagesToLoad[a].currentSrc || y.imagesToLoad[a].getAttribute("src"),
                y.imagesToLoad[a].srcset || y.imagesToLoad[a].getAttribute("srcset"),
                !0,
                e
              );
          }),
            ...
            if ("undefined" != typeof y.size) {
              ...
              y.params.slidesPerColumn > 1 &&
                ...
                "auto" !== y.params.slidesPerView &&
                  ...
                  (n = Math.max(n, y.params.slidesPerView * y.params.slidesPerColumn)));
              var o,
          ...
          (y.updateProgress = function (e) {
            ...
            0 === a
              ...
              : ((y.progress = (e - y.minTranslate()) / a), (y.isBeginning = y.progress <= 0), (y.isEnd = y.progress >= 1)),
          ...
          (y.updateClasses = function () {
            ...
            if (
              (y.params.loop && 0 === s.length && y.slides.eq(-1).addClass(y.params.slidePrevClass),
              ...
              if (
                ...
                "fraction" === y.params.paginationType &&
                  (y.paginationContainer.find("." + y.params.paginationCurrentClass).text(r + 1),
              ...
              "custom" === y.params.paginationType &&
                ...
                (y.paginationContainer.html(y.params.paginationCustomRender(y, r + 1, i)),
          ...
          (y.updatePagination = function () {
            if (y.params.pagination && y.paginationContainer && y.paginationContainer.length > 0) {
              ...
              if ("bullets" === y.params.paginationType) {
                for (
                  var a = y.params.loop ? Math.ceil((y.slides.length - 2 * y.loopedSlides) / y.params.slidesPerGroup) : y.snapGrid.length, t = 0;
                  a > t;
                  t++
                )
        ...
        window.navigator.pointerEnabled
          ...
          : window.navigator.msPointerEnabled && (x = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]),
          (y.touchEvents = {
          ...
          (window.navigator.pointerEnabled || window.navigator.msPointerEnabled) &&
            ("container" === y.params.touchEventsTarget ? y.container : y.wrapper).addClass("swiper-wp8-" + y.params.direction),
          (y.initEvents = function (e) {
            ...
            y.browser.ie
              ...
              y.params.nextButton &&
                y.nextButton &&
                y.nextButton.length > 0 &&
                (y.nextButton[a]("click", y.onClickNext), y.params.a11y && y.a11y && y.nextButton[a]("keydown", y.a11y.onEnterKey)),
              y.params.prevButton &&
                y.prevButton &&
                y.prevButton.length > 0 &&
                (y.prevButton[a]("click", y.onClickPrev), y.params.a11y && y.a11y && y.prevButton[a]("keydown", y.a11y.onEnterKey)),
              y.params.pagination &&
          ...
          (y.preventClicks = function (e) {
            y.allowClick ||
              ...
              y.params.preventClicksPropagation && y.animating && (e.stopPropagation(), e.stopImmediatePropagation()));
          }),
          ...
          (y.onTouchMove = function (e) {
            if ((e.originalEvent && (e = e.originalEvent), !G || "mousemove" !== e.type)) {
              if (e.preventedByNestedSwiper)
                return (
                  (y.touches.startX = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX),
              ...
              if ((C && y.emit("onTouchMove", y, e), !(e.targetTouches && e.targetTouches.length > 1))) {
                if (
                  ...
                  var t =
                    (180 * Math.atan2(Math.abs(y.touches.currentY - y.touches.startY), Math.abs(y.touches.currentX - y.touches.startX))) / Math.PI;
                  ...
                  if (A || !y.browser.ieTouch) {
                    ...
                    if (
                      (r > 0 && P > y.minTranslate()
                        ? ((i = !1),
                          y.params.resistance && (P = y.minTranslate() - 1 + Math.pow(-y.minTranslate() + I + r, y.params.resistanceRatio)))
                        : 0 > r &&
                          P < y.maxTranslate() &&
                          ((i = !1),
                ...
                if (y.params.freeModeMomentum) {
                  ...
                  if (u < y.maxTranslate())
                    y.params.freeModeMomentumBounce
                      ? (u + y.maxTranslate() < -f && (u = y.maxTranslate() - f), (c = y.maxTranslate()), (m = !0), (B = !0))
                      : (u = y.maxTranslate());
                  else if (u > y.minTranslate())
                    y.params.freeModeMomentumBounce
                      ? (u - y.minTranslate() > f && (u = y.minTranslate() + f), (c = y.minTranslate()), (m = !0), (B = !0))
                      : (u = y.minTranslate());
                    ...
                    (u =
                      Math.abs(y.snapGrid[g] - u) < Math.abs(y.snapGrid[g - 1] - u) || "next" === y.swipeDirection
                        ? y.snapGrid[g]
                        : y.snapGrid[g - 1]),
                      y.rtl || (u = -u);
                  }
              ...
              for (v = 0; v < y.slidesGrid.length; v += y.params.slidesPerGroup)
                "undefined" != typeof y.slidesGrid[v + y.params.slidesPerGroup]
                  ? r >= y.slidesGrid[v] &&
                    ...
                    ((w = v), (b = y.slidesGrid[v + y.params.slidesPerGroup] - y.slidesGrid[v]))
            ...
            "undefined" == typeof e && (e = !0),
              ...
              e &&
                ...
                y.activeIndex !== y.previousIndex &&
                  (y.emit("onSlideChangeStart", y), y.activeIndex > y.previousIndex ? y.emit("onSlideNextStart", y) : y.emit("onSlidePrevStart", y)));
          }),
          (y.onTransitionEnd = function (e) {
            (y.animating = !1),
              ...
              e &&
                ...
                y.activeIndex !== y.previousIndex &&
                  (y.emit("onSlideChangeEnd", y), y.activeIndex > y.previousIndex ? y.emit("onSlideNextEnd", y) : y.emit("onSlidePrevEnd", y))),
            ...
            y.isHorizontal() ? (s = y.rtl ? -e : e) : (i = e),
              ...
              y.params.virtualTranslate ||
                (y.support.transforms3d
                  ? y.wrapper.transform("translate3d(" + s + "px, " + i + "px, " + n + "px)")
              ...
              setTranslate: function () {
                for (var e = 0; e < y.slides.length; e++) {
                  ...
                  var r = t[0].swiperSlideOffset,
                    ...
                    p = 0;
                  if (
                    (y.isHorizontal() ? y.rtl && (n = -n) : ((p = l), (l = 0), (o = -n), (n = 0)),
                    ...
                    0 === d.length && ((d = a('<div class="swiper-slide-shadow-' + (y.isHorizontal() ? "left" : "top") + '"></div>')), t.append(d)),
                      0 === u.length &&
                        ((u = a('<div class="swiper-slide-shadow-' + (y.isHorizontal() ? "right" : "bottom") + '"></div>')), t.append(u)),
                ...
                if (
                  ...
                  y.slides.eq(y.activeIndex).transitionEnd(function () {
                    if (!t && y && a(this).hasClass(y.params.slideActiveClass)) {
                      (t = !0), (y.animating = !1);
                      for (
                        var e = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"], s = 0;
                        s < e.length;
                        s++
                      )
              ...
              setTranslate: function () {
                ...
                y.params.cube.shadow &&
                  (y.isHorizontal()
                    ...
                    : ((e = y.container.find(".swiper-cube-shadow")),
                      0 === e.length && ((e = a('<div class="swiper-cube-shadow"></div>')), y.container.append(e))));
                for (var s = 0; s < y.slides.length; s++) {
                  ...
                  if ((1 >= o && o > -1 && ((t = 90 * s + 90 * o), y.rtl && (t = 90 * -s - 90 * o)), r.transform(u), y.params.cube.slideShadows)) {
                    ...
                    0 === c.length && ((c = a('<div class="swiper-slide-shadow-' + (y.isHorizontal() ? "left" : "top") + '"></div>')), r.append(c)),
                      0 === m.length &&
                        ((m = a('<div class="swiper-slide-shadow-' + (y.isHorizontal() ? "right" : "bottom") + '"></div>')), r.append(m)),
                ...
                if (
                  ...
                  if (y.isHorizontal())
                    ...
                    e.transform(
                      "scale3d(" + h + ", 1, " + v + ") translate3d(0px, " + (y.height / 2 + w) + "px, " + -y.height / 2 / v + "px) rotateX(-90deg)"
                    );
                  }
                var b = y.isSafari || y.isUiWebView ? -y.size / 2 : 0;
                y.wrapper.transform(
                  "translate3d(0px,0," + b + "px) rotateX(" + (y.isHorizontal() ? 0 : t) + "deg) rotateY(" + (y.isHorizontal() ? -t : 0) + "deg)"
                );
              },
              setTransition: function (e) {
                y.slides
                ...
                for (
                  ...
                  if ((o.transform(h), (o[0].style.zIndex = -Math.abs(Math.round(d)) + 1), y.params.coverflow.slideShadows)) {
                    ...
                    0 === v.length && ((v = a('<div class="swiper-slide-shadow-' + (y.isHorizontal() ? "left" : "top") + '"></div>')), o.append(v)),
                      0 === w.length &&
                        ((w = a('<div class="swiper-slide-shadow-' + (y.isHorizontal() ? "right" : "bottom") + '"></div>')), o.append(w)),
          ...
          (y.lazy = {
            ...
            onTransitionStart: function () {
              y.params.lazyLoading &&
                (y.params.lazyLoadingOnTransitionStart || (!y.params.lazyLoadingOnTransitionStart && !y.lazy.initialImageLoaded)) &&
                y.lazy.load();
            },
            ...
            setTranslate: function () {
              if (y.params.scrollbar) {
                ...
                (e = (a.trackSize - a.dragSize) * y.progress),
                  ...
                  y.isHorizontal()
                    ? (y.support.transforms3d ? a.drag.transform("translate3d(" + e + "px, 0, 0)") : a.drag.transform("translateX(" + e + "px)"),
                      (a.drag[0].style.width = t + "px"))
                    : (y.support.transforms3d ? a.drag.transform("translate3d(0px, " + e + "px, 0)") : a.drag.transform("translateY(" + e + "px)"),
              ...
              function s(a) {
                (e = a.rtl && "horizontal" === a.params.direction ? -y.translate : y.translate),
                  ...
                  (i && "container" !== y.params.controlBy) ||
                    ((r = (a.maxTranslate() - a.minTranslate()) / (y.maxTranslate() - y.minTranslate())),
        ...
        return (
          ...
          (y.init = function () {
            y.params.loop && y.createLoop(),
              ...
              "slide" !== y.params.effect &&
                ...
                (y.params.loop || y.updateProgress(), y.effects[y.params.effect].setTranslate()),
              y.params.loop
          ...
          (y.cleanupStyles = function () {
            y.container.removeClass(y.classNames.join(" ")).removeAttr("style"),
              ...
              y.params.scrollbar &&
                y.scrollbar &&
                (y.scrollbar.track && y.scrollbar.track.length && y.scrollbar.track.removeAttr("style"),
